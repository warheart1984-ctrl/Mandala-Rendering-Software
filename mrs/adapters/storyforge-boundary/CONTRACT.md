...
| Production contract `storyforge-mandala-contract/1.0` identity compare | **partial** | `contract/test_contract.py` |
| Beatbox / Speakers / NTP film assembly | **declared** | Infinity lanes; adapter handoff only |
